...
const NumberNode: React.FC<NumberNodeProps> = ({ data, id, selected }) => {
  ...
  return (
    <div className={`group relative transition-all duration-200 ${
      ...
      <div className={`min-w-48 w-auto h-auto min-h-28 rounded-xl bg-white dark:bg-[#0E0E0E]/90 border border-gray-200 dark:border-[#1A1A1A] shadow-sm transition-all duration-200 relative overflow-hidden ${
        selected 
