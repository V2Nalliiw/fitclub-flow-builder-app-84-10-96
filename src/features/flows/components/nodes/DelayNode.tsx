...
export const DelayNode: React.FC<DelayNodeProps> = ({ data, selected, id, onDelete, onDuplicate }) => {
  ...
  return (
    <div className={`group relative transition-all duration-200 ${
      ...
      <div className={`min-w-36 w-auto h-auto min-h-20 rounded-xl bg-white dark:bg-none dark:bg-[#0E0E0E]/90 border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-200 relative overflow-hidden ${
        selected 
