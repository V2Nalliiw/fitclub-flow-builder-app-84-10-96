...
const SimpleCalculatorNode: React.FC<SimpleCalculatorNodeProps> = ({ data, id, selected }) => {
  ...
  return (
    <div className={`group relative transition-all duration-200 ${
      ...
      <div className={`w-52 min-h-32 rounded-xl bg-white dark:bg-gray-800/90 border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-200 relative overflow-hidden ${
        selected 
