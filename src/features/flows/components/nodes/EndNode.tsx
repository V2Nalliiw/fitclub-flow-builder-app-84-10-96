...
export const EndNode: React.FC<EndNodeProps> = ({ data, selected, id, onDelete, onDuplicate }) => {
  return (
    <div className={`group relative px-4 py-4 shadow-md rounded-lg bg-white dark:bg-white/10 text-foreground border transition-all duration-200 w-40 h-28 flex flex-col justify-center ${
