...
interface MedicalQuestionnaireRendererProps {
  step: any;
  onComplete: (response: any) => void;
  isLoading?: boolean;
}

export const MedicalQuestionnaireRenderer: React.FC<MedicalQuestionnaireRendererProps> = ({
  step,
  onComplete,
  isLoading = false
}) => {
