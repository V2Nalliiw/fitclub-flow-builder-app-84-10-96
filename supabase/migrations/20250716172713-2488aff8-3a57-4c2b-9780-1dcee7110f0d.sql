-- 1. Primeiro, vamos remover o cron job existente se houver
SELECT cron.unschedule('process-delay-tasks');

-- 2. Criar o cron job atualizado com service_role_key
...
SELECT * FROM cron.job WHERE jobname = 'process-delay-tasks';